...
class Vur:
    ...
    fieldMap = (
        ('UPD_CNT', 'U1'),
        ('UPD_NAM', 'k0Cn'),
        ('VUR_DUMMY', 'U1')  # VUR_DUMMY is for compatibility with the STDF from UF Plus
    )
...
class Mir:
  ...
  Function:
    ...
    stream must have exactly oneMIR, immediately after the FAR (and the ATR's,
  ...
  Data Fields:
    ...
    SBLOT_ID C*n  Sub-lot ID                                length byte = 0
